...
/**
 * This class is a wrapper for a singleton Client object to be used throughout the application for sending HTTP requests
 * to Data Commons.
 */
public class CustomClient {
	...
	/**
	 * Adds a Basic Authentication filter to the client. The filter adds the Basic Web Authentication header to all
