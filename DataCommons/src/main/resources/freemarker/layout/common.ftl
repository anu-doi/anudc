...
<header class="clearfix">
	<div id="bnr-wrap" class="container">
		...
		<div class="float-left">
			<a class="" href="http://www.anu.edu.au/">
				<img class="text-white" src="//marketing-pages.anu.edu.au/_anu/4/images/logos/2x_anu_logo_small.png" alt="The Australian National University" width="150px"/>
			</a>
		</div>
		</div>
		<div id="bnr-mid" class="float-left">
			<div class="float-left">
				<img class="" src="//marketing-pages.anu.edu.au/_anu/4/images/logos/pipe_logo_small.png" alt="" width="66" height="51"/>
			</div>
		...
		<div id="bnr-right" class="float-right">
			<form id="searchForm" role="search" method="get" action="//find.anu.edu.au/search">
				<div class="input-group">
					...
					<button id="search1" class="btn-go" name="search1" value="Go"><img src="//marketing-pages.anu.edu.au/_anu/4/images/buttons/search-black.png" alt="Search"/></button>
				</div>
			</form>
		</div>
	<#-- To Do -->
	<#if security??>
		...
		<div id="bnr-low" class="float-right">
...
<nav class="navbar navbar-expand-sm navbar-anu">
	<div class="container">
	<div class="anu-width">
		<div class="collapse navbar-collapse">
			<ul class="navbar-nav mr-auto">
				<li><a class="nav-link nav-brand" href="/DataCommons"><image src="//marketing-pages.anu.edu.au/_anu/4/images/buttons/home-black.png" alt="Home"/></a></li>
				<li class="nav-item"><a class="nav-link" href="/DataCommons/rest/about">About</a></li>
				<li class="nav-item"><a class="nav-link" href="/DataCommons/rest/contribute">Contribute</a></li>
				<li class="nav-item"><a class="nav-link" href="/DataCommons/rest/upload/search">Data search</a></li>
				<li class="nav-item"><a class="nav-link" href="/DataCommons/rest/collreq">Data request</a></li>
				<li class="nav-item"><a class="nav-link" href="https://openresearch.anu.edu.au/contact">Contact</a></li>
				<#if security??>
					<#if security.getUsername()??>
				<li class="nav-item"><a class="nav-link" href="/DataCommons/logout">Logout</a></li>
				<li class="nav-item"><a class="nav-link" href="/DataCommons/rest/admin">Administration</a></li>
					<#else>
				<li class="nav-item"><a class="nav-link" href="/DataCommons/login-select">Login</a></li>
					</#if>
				<#else>
				<li class="nav-item"><a class="nav-link" href="/DataCommons/login-select">Login</a></li>
				</#if>
...
<footer id="footer-wrap" class="bg-dark text-light">
	...
	<div id="anu-footer" class="bg-dark anu-width pt-2">
		...
		<div id="anu-groups">
			<div class="anu-ftr-go8 px-2"><a href="http://www.anu.edu.au/about/partnerships/group-of-eight"><img class="text-white" src="http://marketing-pages.anu.edu.au/_anu/4/images/logos/2x_GroupOf8.png" alt="Group of Eight Member" /></a></div>
			<div class="anu-ftr-iaru px-2"><a href="http://www.anu.edu.au/about/partnerships/international-alliance-of-research-universities"><img class="text-white" src="http://marketing-pages.anu.edu.au/_anu/4/images/logos/2x_iaru.png" alt="IARU" /></a></div>
			<div class="anu-ftr-apru px-2"><a href="http://www.anu.edu.au/about/partnerships/association-of-pacific-rim-universities"><img class="text-white" src="http://marketing-pages.anu.edu.au/_anu/4/images/logos/2x_apru.png" alt="APRU" /></a></div>
			<div class="anu-ftr-edx px-2"><a href="http://www.anu.edu.au/about/partnerships/edx"><img class="text-white" src="http://marketing-pages.anu.edu.au/_anu/4/images/logos/2x_edx.png" alt="edX" /></a></div>
		</div>
	</div>
	</div>
</footer>
