...
SET tooltip = replace(tooltip, 'http://www.opendatacommons.org/licences/pddl/1.0/', '<a target="_blank" rel="noopener noreferrer" href="https://www.opendatacommons.org/licenses/pddl/1.0/">https://www.opendatacommons.org/licenses/pddl/1.0/</a>');

--replacing ausgoal link
UPDATE template_attribute 
SET tooltip = replace(tooltip, 'http://www.ausgoal.gov.au/the-ausgoal-licence-suite', '<a target="_blank" rel="noopener noreferrer" href="https://creativecommons.org/licenses/">https://creativecommons.org/licenses/</a>');
...
UPDATE template_attribute 
SET tooltip = replace(tooltip, 'http://libguides.anu.edu.au/datamanagement/', '<a target="_blank" rel="noopener noreferrer" href="https://libguides.anu.edu.au/research-data-management">https://libguides.anu.edu.au/research-data-management</a>');
