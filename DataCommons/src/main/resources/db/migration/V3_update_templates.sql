insert into template (id, template_pid, name, description) values (8, 'tmplt:8', 'LTERN Collection Template', 'LTERN Collection template for recording Datasets') on conflict do nothing;
