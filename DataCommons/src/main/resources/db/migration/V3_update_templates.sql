...
insert into template_attribute (id, template_id, name, label, field_type_id, select_code, multivalued, required, template_tab_id, form_order, display_order, max_length, extra,tooltip) values
	...
	,(5,1,'subType','Collection Type','4','collection_sub_type','0','1',1,5,5,null,null,'<strong>Catalogue or Index</strong> - a collection of descriptions describing the content of one or more collective works at the item level.<br/><strong>Collection</strong> - compiled content created as separate and independent works and assembled into a collective whole<br/><strong>Registry</strong> - a collection of registry objects compiled to support the business of a given community<br/><strong>Repository</strong> - a collection of physical or digital objects compiled for information and documentation purposes and/or for storage and safekeeping<br/><strong>Dataset</strong> - a collection of physical or digital objects generated by research activities.<br/><strong>Classification Scheme</strong> - A list or arrangement of terms used in a particular context e.g. ontologies, thesauri<br/><strong>Software</strong> - One or more items that represent a software product')
	...
	,(42,1,'dataRetention','Retention Period','1',null,'0','0',7,42,42,null,null,'Include the period of time that the data must be retained. This must be in line with institutional/funding body or legistlative retention<br/><br/>Examples:<br/>7 years<br/><br/>Until 31st December 2016<br/><br/>Indefinitely')
...
insert into template_attribute (id, template_id, name, label, field_type_id, select_code, multivalued, required, template_tab_id, form_order, display_order, max_length, extra,tooltip) values
	...
	,(72,3,'subType','Service Type','3','service_sub_type','0','1',13,2,2,null,'required','<strong>Create</strong> - produces a new data object representing existing phenomona in the world, including physical reality and user input. An instrument creates data<br/><strong>Generate</strong> - procues a new data object out of mathematical formulae and parameters, rather than capturing and representing existing data in the world. A simulator generates data. (The simulation is the generated data.) A random number generator generates data.<br/><strong>Report</strong> - Presents existing data in ta summary form. A visualisation reports on data.<br/><strong>Annotate</strong> - Links an annotation to a data object, or part thereof.<br/><strong>Transform</strong> - Changes a data object into a new data object, with a distinct format. An analysis tool creates a new data object out of data (either raw data, or other analyses).<br/><strong>Assemble</strong> - Builds a new data object instance composed of exsiting data objects. A survey generation tool creates a survey form out of user input and templates.<br/><strong>OAI-PMH Harvest</strong> - Open Archives Initiative Protocol for Metadata Harvesting. See also <a href="http://www.openarchives.org/">http://www.openarchives.org/</a><br/><strong>Search service over HTTP</strong> - RFC2626.<br/><strong>OpenSearch search</strong> - a collection of technologies that allow publishing of search results in a format suitable for syndication and aggregation.<br/><strong>SRU search</strong> - SRU is a standard XML-focused search protocol for Internet search queries based on Z39.50 semantics.<br/><strong>z39.50 search</strong> - the International Standard, ISO 23950: Information Retrieval (Z39.50): Application Service Definition and Protocol Specification, (also ANSI/NISO Z39.50). The standard specifies a client/server-based protocol for searching and retrieving information from remove databases.<br/><strong>ATOM syndication</strong> - an XML-based Web content and metadata syndication format. <a href="http://tools.ietf.org/html/rfc4287">http://tools.ietf.org/html/rfc4287</a><br/><strong>RSS feed</strong> - a family of web feed formats that are specified using XML.')
...
insert into template_attribute (id, template_id, name, label, field_type_id, select_code, multivalued, required, template_tab_id, form_order, display_order, max_length, extra,tooltip) values
	...
	,(185,8,'dataRetention','Retention Period','1',null,'0','0',32,45,45,null,null,'Include the period of time that the data must be retained. This must be in line with institutional/funding body or legistlative retention<br/><br/>Examples:<br/>7 years<br/><br/>Until 31st December 2016<br/><br/>Indefinitely')
