...
<anu:header id="1998" title="Browse results for ${fn:escapeXml(param['field-select'])}" description="description" subject="subject" respOfficer="ANU Library" respOfficerContact="mailto:repository.admin@anu.edu.au"
	ssl="true">
