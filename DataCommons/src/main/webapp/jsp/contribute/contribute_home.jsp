...
<anu:content layout="one-third">
	<div class="bg-tint p-1 mb-2">
		<div>
			...
			<div>
				<h4><a class="nounderline" href='<c:url value="/rest/contribute/data"/>'>Contribute your data </a></h4>
			</div>
		</div>
	</div>
</anu:content>
...
<anu:content layout="one-third">
	<div class="bg-tint p-1 mb-2">
		<div>
			...
			<div>
				<h4><a class="nounderline" href="https://openresearch.anu.edu.au/node/34">Contribute your research <img alt="external link" src='<c:url value="https://style.anu.edu.au/_anu/images/icons/web/link.png"/>' /></a></h4>
			</div>
		</div>
	</div>
</anu:content>
...
<anu:content layout="one-third">
	<div class="bg-tint p-1 mb-2">
		<div>
			...
			<div>
				<h4><a class="nounderline" href="https://openresearch.anu.edu.au/node/33">Contribute your thesis <img alt="external link" src='<c:url value="https://style.anu.edu.au/_anu/images/icons/web/link.png"/>' /></a></h4>
			</div>
		</div>
	</div>
</anu:content>
